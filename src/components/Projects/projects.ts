...
export default [
  {
    title: 'IJ Construtora',
    description: 'Site institucional, com foco em apresentar os serviços e projetos da empresa de forma moderna e acessível.',
    imgUrl: ijContrutoraImg,
